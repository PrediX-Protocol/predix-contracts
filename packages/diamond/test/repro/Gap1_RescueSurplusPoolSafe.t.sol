...
contract Gap1RescueSurplusPoolSafe is EventFixture {
    function test_RescueSurplus_DoesNotTouchEventPool() public {
        ...
        vm.prank(alice);
        eventFacet.splitEvent(eventId, 25e6);

        assertEq(eventFacet.eventPoolOf(eventId), 25e6, "pool seeded");
        ...
        assertEq(eventFacet.eventPoolOf(eventId), 25e6, "pool untouched");
    ...
    function test_RescueSurplus_RecoversOnlyTrueSurplus() public {
        ...
        assertEq(eventFacet.eventPoolOf(eventId), 25e6, "pool still untouched");
    }
}
